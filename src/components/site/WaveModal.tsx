...
function WaveAnim({ wave }: { wave: WaveInfo }) {
  ...
  return (
    <div className="relative aspect-[16/6] w-full min-w-0 max-w-full overflow-hidden rounded-2xl bg-navy [contain:layout_paint]">
      <svg viewBox="0 0 800 220" className="absolute inset-0 h-full w-full min-w-0 max-w-full overflow-hidden" preserveAspectRatio="none">
        <defs>
          ...
          <div className="grid w-full min-w-0 max-w-full grid-cols-[minmax(0,1fr)] gap-0 overflow-hidden md:grid-cols-[minmax(0,1fr)_220px] md:overflow-visible">
            <div className="w-full min-w-0 max-w-full overflow-hidden p-4 pt-10 sm:p-6 sm:pt-10 md:overflow-visible">
              ...
              <div className="mt-6 w-full min-w-0 max-w-full">
                <div className="flex w-full min-w-0 max-w-full flex-wrap items-baseline gap-3">
                  <h3 className="min-w-0 break-words font-display text-2xl font-bold text-navy sm:text-3xl">{wave.name} Waves</h3>
                  <span
            ...
            <aside className="relative w-full min-w-0 max-w-full overflow-hidden border-t border-border bg-secondary/40 p-4 md:overflow-visible md:border-l md:border-t-0">
              <p className="mb-3 px-1 text-[11px] font-semibold uppercase tracking-wider text-muted-foreground">
                Other waves
              </p>
              <div className="flex w-full min-w-0 max-w-full gap-3 overflow-x-auto overflow-y-hidden pb-1 pr-10 [scroll-padding-right:2.5rem] md:flex-col md:gap-2 md:overflow-visible md:pr-0">
                {WAVES.map((w) => {
