...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "BrainWaves Tech — Neurofeedback & Brainwave Analysis Platform" },
      { property: "og:description", content: "Assess Brain Activity • Understand Cognitive Patterns • Deliver Customized Neurofeedback & Sound Therapy Solutions" },
